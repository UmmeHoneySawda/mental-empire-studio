      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 16, borderTop: '1px solid #1d2129', paddingTop: 20 }}>
        <div style={{ flex: 1, maxWidth: 430 }}>
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <div onClick={browse} className="me-btn" style={{ border: '1px solid #262b34', background: '#15181f', borderRadius: 9, padding: '10px 14px', fontSize: 12, color: '#c4cad3', cursor: 'pointer' }}>Browse</div>
          </div>
        </div>
